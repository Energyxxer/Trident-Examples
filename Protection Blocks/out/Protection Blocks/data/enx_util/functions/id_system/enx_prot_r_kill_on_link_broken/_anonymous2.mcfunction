execute if entity @s[tag=trident-component.enx_util.enx_prot_r_unlinked] run kill @s
...
execute unless entity @e[tag=trident-component.enx_util.enx_prot_r_id_holder,tag=link_return,limit=1] run kill @s
